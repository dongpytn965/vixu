const nameGirl = 'Chị Vixu';
const giftUrl = '';
const eventName = 'Chúc Mừng 20-10';
const titleCard = 'Tặng Chị Trân';
const contentCard = 'Chúc chị 20/10 vui vẻ, Chúc chị luôn luôn xinh đẹp, hạnh phúc và thành công trong cuộc sống';
